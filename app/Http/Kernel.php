...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'is_authorizing_middleware' => is_authorizing_middleware::class,
        'is_submitting_middleware' => is_submitting_middleware::class,
        'is_selecting_user' => is_selecting_partner_middleware::class,
    ];
}
